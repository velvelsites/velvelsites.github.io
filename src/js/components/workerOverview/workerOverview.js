    ...
    groupWorkersByYearMonth(year, month){
        ...
        _.forEach(this.workers, (workerUnits, workerId)=>{
            ...
            _.forEach(siteGroup,(site, siteId)=>{
                ...
                if(newSite.days > 0){
                    newSite.siteTotal = parseFloat(this.dailyWorkerTotal(newSite.hourlyRate,newSite.hours,newSite.commute))
...
var cssTemplate = 'body{-webkit-print-color-adjust: exact; print-color-adjust: exact;font-size:10px;direction:rtl;}.top-gap{margin-top:15px;}#cell-large{width:100px;}.card{padding: 15px;border-radius: 4px;box-shadow: 0 1px 2px rgba(0, 0, 0, 0.05), 0 0 0 1px rgba(63, 63, 68, 0.1);background-color: #FFFFFF;margin-bottom: 10px;margin-top: 1px;float: left;width: 95%;}.card .row {    margin: 0px;    padding: 10px;}.card .card-content {    padding: 10px;} .worker-table-header {  box-shadow: inset 0 0 0 1000px #C7DAFA; color: #fff;}.worker-table-line span, .worker-table-header span {    display: inline-block;    width: 60px;    padding: 8px;    line-height: 1.42857;}.worker-table-line, .worker-table-header {    border-top: 1px solid #ddd;}.worker-site-detail {    display: flex;    flex-direction: row;    flex-wrap: nowrap;    justify-content: flex-start;    align-items: center;    align-content: stretch;}.worker-site-detail div {    width: 60px;    padding: 8px;}.worker-monthly{    padding: 10px;margin: 0px;}'
